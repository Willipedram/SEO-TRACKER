...
Phase 24 schema version 14 adds evidence-based indexes for website/date rank reports,
date-window movement reports, and per-user sync throttling. These complement rather
than replace the device-specific dashboard, keyword-history, Search Console aggregate,
and queue-claim indexes.
