...
final class AdminLteUiTest extends TestCase
{
    ...
    public function testUserIpRankRunnerHasModalAndIncognitoExtensionContracts(): void
    {
        ...
        foreach(['incognito:true','pws=0','page<10','chrome.scripting.executeScript','SEO_RANK_DONE','chrome.tabs.get','sender.tab?.id'] as $required)$this->assertTrue(str_contains($worker,$required));
