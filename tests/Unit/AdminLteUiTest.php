...
final class AdminLteUiTest extends TestCase
{
    ...
    public function testUserIpRankRunnerHasModalAndIncognitoExtensionContracts(): void
    {
        ...
        $this->assertSame('split',$manifest['incognito']);
        ...
        foreach(['incognito:true','pws=0','page<10','chrome.scripting.executeScript','SEO_RANK_DONE','chrome.permissions.request','registerContentScripts','sender.tab?.id'] as $required)$this->assertTrue(str_contains($worker,$required));
