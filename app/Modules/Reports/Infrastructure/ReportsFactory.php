...
final class ReportsFactory
{
    ...
    public function translator(): Translator { return new Translator((string) $this->config->get('app.locale', 'en'), $this->basePath, 'reports'); }
    public function isRtl(): bool { $locale = explode('-', (string) $this->config->get('app.locale', 'en'), 2)[0]; return in_array($locale, (array) $this->config->get('app.rtl_locales', []), true); }
}
