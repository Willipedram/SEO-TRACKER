...
final class SettingsFactory
{
    ...
    public function translator(): Translator { return new Translator((string) $this->config->get('app.locale', 'fa'), $this->basePath, 'settings'); }
    public function isRtl(): bool { return in_array(explode('-', (string) $this->config->get('app.locale', 'fa'), 2)[0], (array) $this->config->get('app.rtl_locales', []), true); }
}
